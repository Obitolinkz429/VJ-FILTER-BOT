...
BOT_TOKEN = environ.get('BOT_TOKEN', "6118209222:AAEoXLWP7OYxhBAsk8dzoC1L2uVOQIyans0")
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1217549670').split()] # For Multiple Id Use One Space Between Each.
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001610148581').split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://PRABHA:PRABHA@cluster0.iycibgx.mongodb.net/?retryWrites=true&w=majority")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Movie_Requestgrp')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+t_IHhimp7EgxMTNl')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Movie_Requestgrp') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Movie_Requestgrp')
